...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT flatbuffers::libflatbuffers #############
        ...
        set_property(TARGET flatbuffers::libflatbuffers PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${flatbuffers_flatbuffers_libflatbuffers_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET flatbuffers::libflatbuffers PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${flatbuffers_flatbuffers_libflatbuffers_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET flatbuffers::libflatbuffers PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${flatbuffers_flatbuffers_libflatbuffers_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET flatbuffers::libflatbuffers PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${flatbuffers_flatbuffers_libflatbuffers_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET flatbuffers::libflatbuffers PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${flatbuffers_flatbuffers_libflatbuffers_COMPILE_OPTIONS_RELEASE}> APPEND)

    ########## AGGREGATED GLOBAL TARGET WITH THE COMPONENTS #####################
    set_property(TARGET flatbuffers::flatbuffers PROPERTY INTERFACE_LINK_LIBRARIES flatbuffers::libflatbuffers APPEND)
